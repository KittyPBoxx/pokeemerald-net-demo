...
async function runTests() {
    ...
    // Blank Friend code       [glitter mail]
       0x00, 0x00, 0x00, 0x00, 0x00, 0x7B,
    // [ EC_RED  ] [EC_GREEN ] [ EC_GOLD ] [ EC_LEAF]  [ EC_LEAF]  [ EC_LEAF]  [ EC_LEAF]  [ EC_LEAF]  [ EC_LEAF]
       0x02, 0x13, 0x02, 0x14, 0x02, 0x17, 0x02, 0x18, 0x02, 0x18, 0x02, 0x18, 0x02, 0x18, 0x02, 0x18, 0x02, 0x18  
    ]));
    await sleep(BETWEEN_TEST_DELAY); 
    ...
    // 50,0,50,0 Friend code   [glitter mail]
       0x50, 0x00, 0x50, 0x00, 0x00, 0x7B,
    // [ EC_RED  ] [EC_GREEN ] [ EC_GOLD ] [ EC_LEAF]  [ EC_LEAF]  [ EC_LEAF]  [ EC_LEAF]  [ EC_LEAF]  [ EC_LEAF]
       0x02, 0x13, 0x02, 0x14, 0x02, 0x17, 0x02, 0x18, 0x02, 0x18, 0x02, 0x18, 0x02, 0x18, 0x02, 0x18, 0x02, 0x18  
    ]));
    await sleep(500); 
...
function verifyReadMessageNoFriendKeyResponse(data) {
    let expected = [
        //  MESSAGE_TYPE, MESSAGE_OFFSET, MESSAGE_LENGTH_BYTE_1, MESSAGE_LENGTH_BYTE_2, ASCII_UNDERSCORE 
            0x25, 0xf0, 0x00, 0x1c, 0x5f,
        // B     r     a     n     d     o     n     END   [GLITTER MAIL]
           0xBC, 0xE6, 0xD5, 0xE2, 0xD8, 0xE3, 0xE2, 0xFF, 0x00, 0x7B,
        // [ EC_RED  ] [EC_GREEN ] [ EC_GOLD ] [ EC_LEAF]  [ EC_LEAF]  [ EC_LEAF]  [ EC_LEAF]  [ EC_LEAF]  [ EC_LEAF]
           0x02, 0x13, 0x02, 0x14, 0x02, 0x17, 0x02, 0x18, 0x02, 0x18, 0x02, 0x18, 0x02, 0x18, 0x02, 0x18, 0x02, 0x18];
    return assertTrue(() => compHex(data, expected),
